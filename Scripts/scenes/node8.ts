/*
    ...
    Revision History:      Set the Initial Node 8 components aka comments, buttons, and scene switches.
*/

module scenes {
    export class Node8 extends objects.Scene {
        ...
        public start(): void {
            ...
            this._gameLabel = new objects.Label("PLAY NODE 8", "60px Consolar", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y);
