/*
    ...
    Revision History:      Set the Node 1 Choice Buttons.
*/
...
(function (scenes) {
    var Node1 = (function (_super) {
        ...
        Node1.prototype.start = function () {
            ...
            this._gameBtnChoice1 = new objects.Button("CHOICE_Insult", config.Screen.CHOICE1_X, config.Screen.CHOICE1_Y);
            ...
            this._gameBtnChoice2 = new objects.Button("CHOICE_Flatter", config.Screen.CHOICE2_X, config.Screen.CHOICE2_Y);
