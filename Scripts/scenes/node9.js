/*
    ...
    Revision History:      Set the Initial Node 9 components aka comments, buttons, and scene switches.
*/
...
(function (scenes) {
    var Node9 = (function (_super) {
        ...
        Node9.prototype.start = function () {
            ...
            this._gameLabel = new objects.Label("PLAY NODE 9", "60px Consolar", "#000000", config.Screen.CENTER_X, config.Screen.CENTER_Y);
